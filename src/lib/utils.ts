...
export const PARAMETRIC_MODELS: ModelConfig[] = [
  ...
  },
  {
    ...
    name: 'CAD Quick',
    description: 'Lightweight preview model for fast CAD iterations',
    provider: 'Google',
    supportsTools: true,
    supportsThinking: true,
    supportsVision: true,
    disabled: true,
    tokenCost: FEATURE_COSTS.parametricCadQuick.tokens,
  },
  {
    ...
    supportsThinking: true,
    supportsVision: true,
    tokenCost: FEATURE_COSTS.parametricCadMax.tokens,
  },
];
