export const THREE_D_OBJECT_PROMPT_ENFORCEMENT =
  'Mandatory output: a single centered 3D model, 3D object, or 3D character asset, fully textured and rendered with visible depth, form, volume, and materials under even neutral lighting. Use a plain white or transparent-looking studio background with no cast shadows, no ground shadows, and no baked-in shadow marks on the model or texture. Keep the whole object in frame, and include no text, labels, UI, logos, scenery, or flat 2D illustration. If the user asks for a photo, poster, scene, logo, icon, product ad, or 2D artwork, convert the subject into one standalone physical 3D object asset instead. The result must look like a render of a physical 3D model, not a flat 2D illustration, photo, poster, or concept sketch.';
