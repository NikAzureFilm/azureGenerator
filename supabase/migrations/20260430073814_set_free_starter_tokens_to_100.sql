-- Canonical copy of the "set free starter tokens to 100" migration.
--
-- The linked production project recorded this change under timestamp
-- 20260430073814. Keep this file so `supabase db push` can reconcile the
-- remote migration history without failing on a missing local version.
