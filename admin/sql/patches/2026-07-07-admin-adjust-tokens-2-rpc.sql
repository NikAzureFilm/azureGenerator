-- Patch (2 of 2): admin_adjust_tokens RPC + consumption-metrics predicate fix.
--
-- Apply AFTER 2026-07-07-admin-adjust-tokens-1-enum.sql (which adds the
-- 'admin_adjustment' enum value this function writes). Paste this whole file
...
--      admin/sql/admin_explorer.sql; this file is the delta for the live DB and
--      is kept byte-for-byte in sync with them. Re-running is safe.
--
-- Matching migration: supabase/migrations/20260707120200_admin_adjust_tokens_rpc.sql
